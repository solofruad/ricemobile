// Listado precargado de departamentos y municipios de Colombia (33 departamentos, 1120 municipios).
// Fuente: DIVIPOLA (lista estandar de municipios).

export type ColombiaLocation = {
  departamento: string;
  municipios: string[];
};
